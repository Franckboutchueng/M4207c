 ...
 */
final class Version20220202160033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acces (id INT AUTO_INCREMENT NOT NULL, util_id INT NOT NULL, doc_id INT NOT NULL, autorisation_id INT NOT NULL, INDEX IDX_D0F43B10CF5D2E80 (util_id), INDEX IDX_D0F43B10895648BC (doc_id), INDEX IDX_D0F43B1052C5E836 (autorisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
